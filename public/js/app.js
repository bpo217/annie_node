...
(function() {
  var photographyImageManager, setup, stylistImageManager;
  ...
  photographyImageManager = {
    ...
    setup: function() {
      ...
      return $previous.on('click', function(e) {
        return photographyImageManager.previousPhoto();
      });
    },
    setupMedia: function() {
  ...
  stylistImageManager = {
    ...
    setup: function() {
      ...
      stylistImageManager.setupImages(2, 3);
